...
public class KafkaConfiguration {
    ...
    @Bean
    public  <T extends KafkaMessage> ProducerFactory<String, T> kafkaMessageProducerFactory(ObjectMapper objectMapper) {
...
/*альтренатива
    @Bean
    public KafkaTemplate<String, UserMessage> kafkaTemplate(ObjectMapper objectMapper) {
        return new KafkaTemplate<>(kafkaMessageProducerFactory(objectMapper));
    }
*/
    @Bean
